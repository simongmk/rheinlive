...
for(const file of ['cities.mjs','transit.mjs','trip.mjs','api.mjs','monitor.mjs','monitor-api.mjs','station-index.mjs','platforms.mjs','platform-data.mjs'])await cp(resolve(root,'lib',file),resolve(root,'dist/server/lib',file));
for(const file of ['cities.mjs','transit.mjs','monitor.mjs','journey-platform.mjs'])await cp(resolve(root,'lib',file),resolve(root,'dist/client/lib',file));
