...
createServer(async(req,res)=>{
  try{
    const url=new URL(req.url,'http://localhost');const request=new Request(url,{method:req.method});
    ...
    if(base.endsWith('/lib')&&!['transit.mjs','cities.mjs'].includes(relative)){res.writeHead(404);res.end();return;}
