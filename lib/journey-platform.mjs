...
export const freshDetail=(detail,now)=>Number.isFinite(detail?.fetchedAt)&&Number.isFinite(now)&&now-detail.fetchedAt<=MAX_SNAPSHOT_AGE_MS&&detail.fetchedAt-now<=30000;
